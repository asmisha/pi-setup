---
name: pr-description
description: Write or revise pull request titles and descriptions with a reason-first, technical-document style. Use when creating a PR body, rewriting a PR description, renaming a PR, or editing a draft PR.
---
...
- When drafting or rewriting PR title or description text, prefer a subagent drafting pass.
- Use the subagent draft as the base text, then do a final factual pass yourself against the actual diff before publishing.
