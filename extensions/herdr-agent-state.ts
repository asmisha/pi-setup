// Originally installed by Herdr; kept here so Pi loads the patched repo-owned copy.
// This integration only activates inside Herdr-managed panes and skips Pi subagent processes.
// @ts-nocheck
